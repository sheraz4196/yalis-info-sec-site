      ...
      <div className="w-full text-center">
        {loading ? (
          <button
            type="button"
            disabled
            className="w-36 mx-auto flex items-center justify-center text-xl py-3 px-8 bg-primary-dark hover:bg-muted-red text-white rounded-sm font-extrabold transition-[background-color 150ms ease-in-out]"
          >
            <div role="status">
              <svg
                aria-hidden="true"
          ...
          <button
            type="submit"
            className="text-xl py-3 px-8 bg-primary-dark hover:bg-muted-red text-white rounded-sm font-extrabold transition-[background-color 150ms ease-in-out]"
          >
            Submit
          </button>
        )}
